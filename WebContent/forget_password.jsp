...
<body>
	...
	<div class="cent-box register-box">
		<div>
			...
			<p>Please input your register email:</p>
			</br>
		</div>
		<div>
				...
				<form action="sendemail" method="get">
					<div class="group">
						<div class="group-ipt email">
							<input type="text" value="" name="email" id="email" class="ipt"
								placeholder="Please input your register email" required>
						</div>
					</div>
					<div class="button">
						<button type="submit" class="login-btn register-btn" id="button">Send
							Email</button>
					</div>
